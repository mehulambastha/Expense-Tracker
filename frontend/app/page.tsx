    ...
    <div className="card bg-base-100 shadow-2xl border-2 m-auto align-middle">
      <div className="card-body">
        ...
        <div className="form-control w-full max-w-xs">
          {/* Input form */}
          {!register ? <p>Haven&apos;t registered yet? <span className='cursor-pointer hover:underline-offset-1 link-primary' onClick={()=>setregister(true)}>Join now!</span></p> : <span></span>}
